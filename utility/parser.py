...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='miRNA_disease_miRNA-target',
    ...
    parser.add_argument('--keep_ratio', type=float, default=1.0, help='Ratio of data to keep (default: 1.0)')  # Thêm dòng này
